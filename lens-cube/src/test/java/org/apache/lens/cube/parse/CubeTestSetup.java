...
public class CubeTestSetup {
  ...
  private void createBaseCubeFacts(CubeMetastoreClient client) throws HiveException, LensException {
    ...
    storageTables = new HashMap<String, StorageTableDesc>();
    storageTables.put(c1, s1);
    properties.put(MetastoreConstants.FACT_COL_START_TIME.concat("user_id_added_in_past"), "2016-01-01");
    properties.put(MetastoreConstants.FACT_COL_END_TIME.concat("user_id_deprecated"), "2016-01-01");
    properties.put(MetastoreConstants.FACT_COL_START_TIME.concat("user_id_added_far_future"), "2099-01-01");
    client.createCubeFactTable(BASE_CUBE_NAME, factName, factColumns, storageAggregatePeriods, 100L, properties,
      storageTables);
