...
public class StorageCandidate implements Candidate {
  ...
  // TODO Remove form QueryAst also
/*  @Getter
  @Setter
  ...
  @Getter
  //TODO map should not be needed now. We are dealing with single storage
  ...
  StorageCandidate(CubeFactTable fact, CubeInterface cube) {
    this.fact = fact;
    this.baseTable = cube;
  }
  ...
  public boolean equals(Object obj) {
    ...
    StorageCandidate other = (StorageCandidate) obj;
