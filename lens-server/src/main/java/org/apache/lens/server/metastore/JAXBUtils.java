    ...
    if (columns != null && !columns.getColumn().isEmpty()) {
      ...
      for (XColumn c : columns.getColumn()) {
        if (!(c.getStartTime() == null)) {
          colStartTimeMap.put(MetastoreConstants.FACT_COL_START_TIME.concat(c.getName()), c.getStartTime());
        }
        if (!(c.getEndTime() == null)) {
          colStartTimeMap.put(MetastoreConstants.FACT_COL_END_TIME.concat(c.getName()), c.getEndTime());
        }
      }
